			...
			<div class="row">
				<div class="col-md-12 col-md-offset-0 text-left">
					<ul>
						...
						<li><a href="{{route('nurseList')}}"><font color="black">Lista Enfermeros</font></a></li>
					</ul>
								...
								<div class="tab">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3>Registrar nuevo Enfermero</h3>

											<form action="{{route('savenurse')}}" method="POST" >
												@csrf
                                                ...
                                                <div class="row form-group">
													<div class="col-md-12">
														...
														<input type="text" name="activo" id="fullname" class="form-control" required="">
													</div>
